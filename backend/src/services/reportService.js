...
const VALID_ACTIONS = [
  ...
  'tracking_account_updated',
  'tracking_account_deleted',
  'tracking_account_restored',
  'tracking_account_status_changed',
  'tracking_session_updated',
  'tracking_sim_updated',
  'tracking_security_updated',
  'tracking_purchase_updated',
  'tracking_account_sold',
  'tracking_sale_updated',
  'tracking_account_assigned',
  'tracking_account_returned',
  'tracking_note_added',
  'tracking_attachment_uploaded',
  'tracking_attachment_deleted',
  'tracking_tag_created',
  'tracking_tag_updated',
  'tracking_tag_deleted',
  'tracking_tag_added',
  'tracking_tag_removed',
  'tracking_bulk_delete',
  'tracking_bulk_status_change',
  'tracking_bulk_assign',
  'tracking_bulk_tag',
  'tracking_import',
